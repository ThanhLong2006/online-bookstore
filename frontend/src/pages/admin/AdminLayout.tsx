  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[240px_1fr]">
      ...
      <aside className="h-fit rounded-2xl border border-amber-200 bg-white shadow-sm lg:sticky lg:top-24 overflow-hidden">
        {/* Header sidebar */}
        <div className="p-4 text-white" style={{ background: 'linear-gradient(135deg, #1A365D, #2B6CB0)' }}>
        ...
        <div className="p-3 space-y-0.5">
          ...
          <NavLink to="/admin" end
            ...
            style={({ isActive }) => isActive ? { background: 'linear-gradient(135deg, #1A365D, #2B6CB0)' } : {}}>
